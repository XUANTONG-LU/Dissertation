...
class EyeSurgeryDataset(Dataset):
    def __init__(self, root: str, subset: str, num2train = 0, transforms=None, removeVacantImage=False):
        ...
        if subset == "training" and num2train:
            img_names = img_names[:num2train]
