...
from eyeSurgeryDatasetModify import EyeSurgeryDataset# or train on original cataract dataset:
...
def main(argc, writer):
    ...
    with open(log_file_dir, "a") as f:
        ...
        f.write(f"Project: UNet on cataract Dataset with modified images")
