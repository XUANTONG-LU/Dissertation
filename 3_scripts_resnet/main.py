...
import torch
import datetime
from utils import train, validate, iou, lr_toolsbox, loss_toolsbox
...
def main(argc, writer):
    ...
    val_ds = EyeSurgeryDataset(root=argc.ds_dir, subset="validation", transforms=EvalTransforms(img_width=img_width, img_height=img_height), removeVacantImage=True)
    ...
    with open(log_file_dir, "a") as f:
        ...
        f.write(f"Project: Resnet-UNet on cataract Dataset")
